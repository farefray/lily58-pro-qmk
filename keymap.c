 ...
 * | LCtl |   Z  |   X  |   C  |   D  |   V  |-------|    |-------|   K  |   H  |   '  |   \  |   /  |  ]   |
 * `-----------------------------------------/ LShift/     \ UTIL \-----------------------------------------'
 *                   | BcSp | LAlt |  Meh | /[Space]/       \[Entr]\  | PAGE | RAlt | LGUI |
 *                   |      |      |      |/       /         \      \ |      |[Caps]|      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK] = LAYOUT( \
  ...
  KC_LCTL, KC_Z, KC_X,    KC_C,    KC_D,   KC_V,        KC_COMM,  KC_DOT,           KC_K,      KC_H,            KC_QUOT, KC_BSLS, KC_SLSH, KC_RBRC, \
                       KC_BSPC, KC_LALT, KC_MEH, LSFT_T(KC_SPC),  LT(_UTIL,KC_ENT), MO(_PAGE), RALT_T(KC_CAPS), KC_LGUI \
),
