 ...
 */
 ...
 [_COLEMAK] = LAYOUT( \
   LALT_T(KC_ESC), KC_1, KC_2,    KC_3,    KC_4,   KC_5,                           KC_6,      KC_7,            KC_8,    KC_9,    KC_0,    KC_EQL,  \
 ...
 * | LCtl |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   '  |   \  |   /  |  ]   |
 * `-----------------------------------------/ LShift/     \ UTIL \-----------------------------------------'
 *                   | Meh  | LAlt | Bspc | /[Space]/       \[Entr]\  | PAGE | RAlt | LGUI |
 *                   |      |      |      |/       /         \      \ |      |[Caps]|      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LBRC, KC_A, KC_S,    KC_D,    KC_F,   KC_G,                                    KC_H,       KC_J,            KC_K,    KC_L,    KC_SCLN, KC_GRV,  \
  KC_LCTL, KC_Z, KC_X,    KC_C,    KC_V,   KC_B,        KC_COMM,  KC_DOT,           KC_N,       KC_M,            KC_QUOT, KC_BSLS, KC_SLSH, KC_RBRC, \
                       KC_LCTL, KC_LALT, KC_BSPC, LSFT_T(KC_SPC),  LT(_UTIL,KC_ENT), MO(_PAGE),  RALT_T(KC_CAPS), KC_LGUI \
),
 ...
 */
 ...
 [_GAME] = LAYOUT( \
   KC_ESC,  KC_1,  KC_2,   KC_3,    KC_4,   KC_5,                             KC_6,    KC_7,   KC_8,   KC_9,    KC_0, _______, \
    KC_TAB, KC_TAB, KC_Q,   KC_W,    KC_E,   KC_R,                             _______, _______, _______, _______, _______, _______, \
    KC_BSPC, KC_LSFT, KC_A,   KC_S,    KC_D,   KC_F,                             _______, _______, _______, _______, _______, _______, \
    KC_LCTL, KC_LCTL, KC_Z,   KC_X,    KC_C,   KC_V,   KC_G,  _______,           _______, _______, _______, _______, _______, _______, \
